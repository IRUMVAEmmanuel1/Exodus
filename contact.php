...
<head>
  <title>Exodus Tours and Travel Agency</title>
  <meta charset="utf-8">
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light bg-primary" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.php">Exodus<span class="text-warning">Travel Agency</span></a>
      ...
      <div class="collapse navbar-collapse " id="ftco-nav">
        ...
        <a href="signup_page.php"><button class="btn btn-warning text-primary" style="border-radius: 10px; background-color: white; height: 40px; width: 140px;font:bold">Login/register</button></a>
      </div>
    </div>
  </nav>
  <!-- END nav -->

  <section class="hero-wrap hero-wrap-2" style="background-image: url('images/ikaze.jpg');">
    <div class="overlay"></div>
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
        <div class="col-md-9 ftco-animate pb-5 text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right text-warning"></i></a></span> <span>Contact us <i class="fa fa-chevron-right text-warning"></i></span></p>
          <h1 class="mb-0 bread text-warning">Contact us</h1>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row d-flex contact-info">
        ...
        <div class="col-md-3 d-flex">
          <div class="align-self-stretch box p-4 text-center">
            ...
            <p><a href="tel://1234567920">+250788608558</a></p>
            <p><a href="tel://1234567920">+250788726181</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="align-self-stretch box p-4 text-center">
            ...
            <p><a href="mailto:info@yoursite.com">exodustta@gmail.com</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="align-self-stretch box p-4 text-center">
            ...
            <p><a href="#">www.exodustta.com</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-12 text-center">
          <div class="img" style="background-image: url(images/bg_2.jpg);">
            <div class="overlay"></div>
            <h2>We Are Exodus Tour and Travel Agency</h2>
            ...
            <p class="mb-0"><a href="./index.php" class="btn btn-primary px-4 py-3">Booking</a></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px">
      ...
      <circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="20" stroke="blue" />
    </svg></div>
