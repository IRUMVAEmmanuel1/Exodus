        ...
        <th scope="row"><?php echo $i ?></th>
         <td><?=$destination->title; ?>/<?=$destination->location; ?></td>                 
            ...
            <td><?=$destination->name; ?></td>
             ...
             <td><button onclick="updateStatus(<?=$destination->id;?>)" id="statusBtn<?=$destination->id;?>" class="status-btn <?=$destination->status==0?'Pending':'disapprove'; ?>"><?=$destination->status==0?'Pending':'Disapprove'; ?></button></td>
