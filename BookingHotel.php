...
$insert="INSERT INTO `bookinghotel`(`hotelName`, `phone`, `fullName`,`email`, `date`, `status`, `numberOfroom`, `Location`) VALUES (?,?,?,?,?,?,?,?)";



$query=$conn->prepare($insert);

$query->execute(array($title,$phone,$name,$email,$date,$status,$number,$location));
