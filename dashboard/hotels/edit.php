...
if(!file_exists('../img/HotelImages/'.$c_image)){
	...
	$c_update="update hotels set hotelName='$title', file_name='$old_image', location='$location', duration= '$time', price='$price', near= '$near'
	where id='$id'";
    ...
    <?php 
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input type="text" class="form-control" id="floatingInput"
                            placeholder="news title" name="hotelName" value=" <?= $user->hotelName; ?>">
                    ...
                    <div class="form-floating mb-3">
                        <input type="file" class="form-control" 
                            ...
                            <input type="hidden" class="form-control" 
                             name="file_old" value=" <?= $user->file_name; ?>">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput"
                            placeholder="news title" name="location" value="<?= $user->location; ?>">
                        <label for="floatingInput">location</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInputs"
                            placeholder="published by" name="duration" value="<?= $user->duration; ?>">
                        <label for="floatingInput">Duration</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInputss"
                            placeholder="Date" name="nearby" value="<?= $user->near; ?>">
                        <label for="floatingInput">near</label>
                    </div>
                    <div class="form-floating mb-3" >
                        <input type="text" class="form-control" id="floatingInputss"
                            placeholder="price" name="price" value="<?= $user->price; ?>">
