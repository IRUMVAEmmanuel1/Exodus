                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../hotels/hotels.php" class="dropdown-item "><i class="fa fa-plus-circle me-2 text-primary"></i>Add hotels</a>
                            <a href="../hotels/destList.php" class="dropdown-item "><i class="fa fa-file me-2 text-primary"></i>hotels List</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../Booked/Bookedhotels.php" class="dropdown-item "><i class="fa fa-plus-circle me-2 text-primary"></i>Tour Booking </a>
                ...
                <div class="bg-light rounded h-100 p-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <tr>
                                    ...
                                    <th scope="col" class="text-primary col-sm-2">Hotel Name</th>
                                    <!-- <th scope="col" class="text-primary">Location</th> -->

                                    <th scope="col" class="text-primary col-sm-1">Location/nearBy</th>
                                    <!-- <th scope="col" class="text-primary col-sm-1">Email</th> -->
                                    <th scope="col" class="text-primary col-sm-1">Number_room</th>
                                    <th scope="col" class="text-primary col-sm-1">phone_number</th>
        ...
        <th scope="row"><?php echo $i ?></th>
         <td><?=$hotels->hotelName; ?></td>                 
            ...
            <td><?=$hotels->Location; ?></td>
             ...
             <td><?=$hotels->phone; ?></td>
             <td><?=$hotels->date; ?></td>
             <td><button onclick="updateStatus(<?=$hotels->id;?>)" id="statusBtn<?=$hotels->id;?>" class="status-btn <?=$hotels->status==0?'approve':'disapprove'; ?>"><?=$hotels->status==0?'Approve':'Disapprove'; ?></button></td>
             <td>
            <a href="delete.php?id=<?=$hotels->id; ?>" onclick="return confirm('Are you sure you want to delete this file with its details permanently? click Ok to continue or click Cancel')"><button class="btn btn-danger">Cancel</button></a>
             </td>
      </tr>
